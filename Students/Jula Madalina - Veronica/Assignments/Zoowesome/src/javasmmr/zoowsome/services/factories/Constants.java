	...
	public final class Constants {
		...
		public static final class Animal {
			...
			public static final class Reptile {
				public static final String Snake = "Ssslo";
				public static final String Lizard = "Linus";
				public static final String Crocodile = "Roco";
			}

			public static final class Bird {
				public static final String Parrot = "Sophia";
				public static final String Swan = "Lady";
				public static final String Turkey = "Buffalo";
			}

			public static final class Aquatic {
				public static final String Whale = "Gray";
				public static final String Lobster = "Rain";
				public static final String Octopus = "Purple";
			}

			public static final class Insect {
				public static final String Butterfly = "Rhiannon";
